...
CSRF_TRUSTED_ORIGINS = ['https://fullstack-forecast-forge-03fcfb305bcd.herokuapp.com','http://127.0.0.1:8000','http://localhost:8000','http://127.0.0.1:3000','http://localhost:8000']
